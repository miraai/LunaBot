...
class Music:
    ...
    @commands.command(name="cachemax", hidden=True)
    @checks.is_owner()
    async def setcachemax(self, size: int):
    ...
    @commands.command(name="player", hidden=True)
    @checks.is_owner()
    ...
    async def playlist_queue(self, ctx, url):
        ...
        await self.bot.say("Playlist added to the queue.")
